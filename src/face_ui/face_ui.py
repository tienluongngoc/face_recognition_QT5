...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget_9.setGeometry(QtCore.QRect(1200, 10, 111, 131))
        ...
        self.bt_add_face = QtWidgets.QPushButton(self.tab_2)
        self.bt_add_face.setGeometry(QtCore.QRect(900, 160, 70, 40))
        self.bt_add_face.setMinimumSize(QtCore.QSize(0, 40))
        self.bt_add_face.setMaximumSize(QtCore.QSize(70, 16777215))
        self.bt_add_face.setObjectName("bt_add_face")
        self.bt_chose_file = QtWidgets.QPushButton(self.tab_2)
        self.bt_chose_file.setGeometry(QtCore.QRect(820, 160, 75, 40))
        self.bt_chose_file.setMaximumSize(QtCore.QSize(75, 50))
        self.bt_chose_file.setObjectName("bt_chose_file")
        self.tb_path = QtWidgets.QLineEdit(self.tab_2)
        self.tb_path.setGeometry(QtCore.QRect(990, 170, 331, 25))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bt_add_person.setText(_translate("MainWindow", "Add"))
        self.bt_update_person.setText(_translate("MainWindow", "Update"))
        self.bt_delete_person.setText(_translate("MainWindow", "Delete"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Data"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Time"))
        self.bt_add_face.setText(_translate("MainWindow", "Add face"))
        self.bt_chose_file.setText(_translate("MainWindow", "Chose file"))
